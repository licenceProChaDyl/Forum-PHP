...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 29 Janvier 2015 à 14:47
...
(11, 14, 'Informatique', '2015-01-29', 'info', 1);
...
(8, 2, 'qsqsqsq@live.fr', '098f6bcd4621d373cade4e832627b4f6', 'moktar', 'nomDeMoktar', 'prenomMoktar', 'azzaaz', 91580, 'orleans', 'non', '2015-01-19', 11, NULL),
(14, 2, 'admin@live.fr', '21232f297a57a5a743894a0e4a801fc3', 'admin', 'nomAdmin', 'prenomAdmin', '4 rue du cocacola', 45000, 'Orleans', 'non', '2015-01-24', 15, 'avatar/14.png'),
(17, 2, 'zaza@live.fr', '8ba97607a1485ccdbe19745ed80cd52d', 'Tintin', 'nomTintin', 'reerer', '', 0, '', 'non', '2015-01-25', 4, NULL),
(27, 2, 'tete@live.fr', 'e10adc3949ba59abbe56e057f20f883e', 'testForm', '', '', '', 0, '', 'non', '2015-01-29', 1, NULL);
...
(36, 5, 48, 14, '2015-01-27', 'test micro'),
(37, 10, 66, 17, '2015-01-29', '99'),
(38, 10, 66, 14, '2015-01-29', '98'),
(40, 10, 66, 27, '2015-01-29', '97 !');
...
(10, 5, 2, '2015-01-24', ' Jeux alakon', 'Tous vos jeux "alakon".', 1, 3, '2015-01-29', 'Tintin'),
...
(20, 11, 14, '2015-01-29', 'sous categ info', 'info', 0, 0, NULL, NULL);
...
(48, 5, 14, 'L''anniversaire de... phpForum', 'Aujourd''hui, c''est un grand jour, le forum est ready to go out!', '2015-01-24', 'ouvert', 5, '2015-01-27', 'admin'),
(49, 6, 14, 'Dylan RockStar', 'Je me prÃ©sente je mâ€™appelle Dylan !', '2015-01-24', 'ouvert', 3, '2015-01-25', 'Tintin'),
...
(66, 10, 8, 'Le compte Ã  rebours', 'Premier Ã  1 Ã  gagnÃ© !\r\n\r\nJe commence : 100.', '2015-01-29', 'ouvert', 3, '2015-01-29', 'Tintin'),
(67, 5, 14, 'COUCOU', 'Bonjour!!', '2015-01-29', 'ouvert', 0, '2015-01-29', 'admin'),
(68, 5, 17, 'Amazinggg', 'mon post', '2015-01-29', 'ouvert', 0, NULL, NULL);
